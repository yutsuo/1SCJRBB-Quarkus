...
public class Card extends ReactivePanacheMongoEntity {
     ...
     * @param rarity
     */
    public Card(ObjectId id, String cardId, String name, String supertype, List<String> subtypes, String level,
            String hp, List<String> types, String evolvesFrom, List<Ability> abilities, List<Attack> attacks,
            List<Weakness> weaknesses, List<String> retreatCost, Integer convertedRetreatCost, String number,
            String artist, String rarity, String flavorText, List<Integer> nationalPokedexNumbers,
            Legalities legalities, Images images) {
        super();
        this.id = id;
        this.cardId = cardId;
        this.name = name;
